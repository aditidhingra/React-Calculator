    ...
    render() {
        return (
            <div className="buttons">
                <button className="calc_button" name='(' onClick={this.buttonPressed}>(</button>
                <button className="calc_button" name='C' onClick={this.buttonPressed}>C</button>
                <button className="calc_button" name=')' onClick={this.buttonPressed}>)</button>
                <button className="calc_button" name='+' onClick={this.buttonPressed}>+</button>
                ...
                <button className="delete" name='CE' onClick={this.buttonPressed}>CE</button>
